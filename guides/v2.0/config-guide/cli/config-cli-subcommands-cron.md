...
<span class="glyphicon-class">
  <p>You must run cron twice: the first time to discover tasks to run and the second time to run the tasks themselves and 2nd cron run must occur on or after scheduled_at time.</p></span>
</div>
